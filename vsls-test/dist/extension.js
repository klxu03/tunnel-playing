...
const liveShareApiVersion = (__webpack_require__(3).version);
/**
...
var mergeConfig = __webpack_require__(69);
...
axios.CanceledError = __webpack_require__(26);
...
axios.toFormData = __webpack_require__(17);

// Expose AxiosError class
axios.AxiosError = __webpack_require__(15);
...
// Expose isAxiosError
axios.isAxiosError = __webpack_require__(73);
...
var defaults = __webpack_require__(13);
var CanceledError = __webpack_require__(26);
...
var AxiosError = __webpack_require__(15);
var transitionalDefaults = __webpack_require__(16);
var toFormData = __webpack_require__(17);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(48)
  },
...
var AxiosError = __webpack_require__(15);
var CanceledError = __webpack_require__(26);
var parseProtocol = __webpack_require__(27);
...
var CombinedStream = __webpack_require__(50);
...
var asynckit = __webpack_require__(57);
...
var util = __webpack_require__(42);
var Stream = (__webpack_require__(33).Stream);
var DelayedStream = __webpack_require__(51);
...
var extname = (__webpack_require__(52).extname)
...
module.exports =
{
  parallel      : __webpack_require__(58),
  serial        : __webpack_require__(65),
  serialOrdered : __webpack_require__(66)
};
...
var iterate    = __webpack_require__(59)
  , initState  = __webpack_require__(63)
  , terminator = __webpack_require__(64)
  ;
...
var abort = __webpack_require__(62)
  , async = __webpack_require__(60)
  ;
...
var serialOrdered = __webpack_require__(66);
...
const validator = __webpack_require__(75);
const XMLParser = __webpack_require__(77);
const XMLBuilder = __webpack_require__(84);
...
const { buildOptions} = __webpack_require__(78);
const OrderedObjParser = __webpack_require__(79);
const { prettify} = __webpack_require__(83);
const validator = __webpack_require__(75);
...
const util = __webpack_require__(76);
const xmlNode = __webpack_require__(80);
const readDocType = __webpack_require__(81);
const toNumber = __webpack_require__(82);
...
const buildFromOrderedJs = __webpack_require__(85);
...
const vscode = __webpack_require__(1);
const vsls = __webpack_require__(2);
const axios_1 = __webpack_require__(4);
const fast_xml_parser_1 = __webpack_require__(74);
...
async function activate(context) {
    ...
    let createShare = vscode.commands.registerCommand('vsls-test.createShare', async () => {
        const share_link = await liveshare?.share();
        vscode.window.showInformationMessage(`Share is being created ${share_link}`);
    });
    context.subscriptions.push(createShare);
    let joinShare = vscode.commands.registerCommand('vsls-test.joinShare', async () => {
    ...
    let searchBlog = vscode.commands.registerCommand('vsls-test.searchBlog', async () => {
